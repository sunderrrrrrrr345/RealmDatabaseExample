package com.example.admin.realmdatabaseexample;
...
import com.example.admin.realmdatabaseexample.adapter.PersonDetailsAdapter;
import com.example.admin.realmdatabaseexample.models.PersonDetailsModel;
import com.example.admin.realmdatabaseexample.utility.Utility;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void getAllWidgets() {
        ...
        lvPersonNameList =  findViewById(R.id.lvPersonNameList);
    }
    ...
    private void setPersonDetailsAdapter() {
        personDetailsAdapter = new PersonDetailsAdapter(getApplicationContext(), personDetailsModelArrayList);
